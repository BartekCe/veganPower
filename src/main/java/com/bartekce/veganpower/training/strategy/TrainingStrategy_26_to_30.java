...
public class TrainingStrategy_26_to_30 extends AbstractTrainingPopulatingStrategy {
    ...
    public List<TrainingUnit> populateTraining(TrainingUnitService trainingUnitService) {
        return trainingUnitService.saveAll(List.of(
                new TrainingUnit(60, List.of(new Exercise(List.of(14, 18, 14, 14, 20)))),
                new TrainingUnit(90, List.of(new Exercise(List.of(20, 25, 15, 15, 23)))),
                new TrainingUnit(120, List.of(new Exercise(List.of(20, 27, 18, 18, 25)))),
                new TrainingUnit(60, List.of(new Exercise(List.of(21, 25, 21, 21, 27)))),
                new TrainingUnit(90, List.of(new Exercise(List.of(25, 29, 25, 25, 30)))),
                new TrainingUnit(120, List.of(new Exercise(List.of(29, 33, 29, 29, 33))))));
    }
}
