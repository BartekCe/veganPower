...
public class TrainingStrategy_41_to_45 extends AbstractTrainingPopulatingStrategy {
    ...
    public List<TrainingUnit> populateTraining(TrainingUnitService trainingUnitService) {
        return trainingUnitService.saveAll(List.of(
                new TrainingUnit(60, List.of(new Exercise(List.of(27, 29, 25, 25, 35)))),
                new TrainingUnit(45, List.of(new Exercise(List.of(19, 19, 22, 22, 18, 18, 22, 35)))),
                new TrainingUnit(45, List.of(new Exercise(List.of(20, 20, 24, 24, 20, 20, 22, 40))))));
    }
}
