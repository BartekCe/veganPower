...
public class TrainingStrategy_31_to_35 extends AbstractTrainingPopulatingStrategy {
    ...
    public List<TrainingUnit> populateTraining(TrainingUnitService trainingUnitService) {
        return trainingUnitService.saveAll(List.of(
                new TrainingUnit(60, List.of(new Exercise(List.of(17, 19, 15, 15, 20)))),
                new TrainingUnit(45, List.of(new Exercise(List.of(10, 10, 13, 13, 10, 10, 9, 25)))),
                new TrainingUnit(45, List.of(new Exercise(List.of(13, 13, 15, 15, 12, 12, 10, 30))))));
    }
}
