...
public class TrainingStrategy_36_to_40 extends AbstractTrainingPopulatingStrategy {
    ...
    public List<TrainingUnit> populateTraining(TrainingUnitService trainingUnitService) {
        return trainingUnitService.saveAll(List.of(
                new TrainingUnit(60, List.of(new Exercise(List.of(22, 24, 20, 20, 25)))),
                new TrainingUnit(45, List.of(new Exercise(List.of(15, 15, 18, 18, 15, 15, 14, 30)))),
                new TrainingUnit(45, List.of(new Exercise(List.of(18, 18, 20, 20, 17, 17, 15, 35))))));
    }
}
