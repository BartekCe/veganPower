...
public class TrainingStrategy_56_to_59 extends AbstractTrainingPopulatingStrategy {
    ...
    public List<TrainingUnit> populateTraining(TrainingUnitService trainingUnitService) {
        return trainingUnitService.saveAll(List.of(
                new TrainingUnit(60, List.of(new Exercise(List.of(30, 44, 40, 40, 55)))),
                new TrainingUnit(45, List.of(new Exercise(List.of(22, 22, 27, 27, 24, 23, 18, 18, 58)))),
                new TrainingUnit(45, List.of(new Exercise(List.of(26, 26, 33, 33, 26, 26, 22, 22, 60))))));
    }
}
